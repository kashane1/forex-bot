#!/usr/bin/env python3
"""CAMPAIGN_012 portfolio-risk diagnostics.

Reads the per-fold per-pair trade CSVs + the fold_detail.json
(``run_campaign_012.py`` output), and produces a compact diagnostics
report describing:
...
All numbers are diagnostic — none gate the verdict. CAMPAIGN_012 is
...
def main() -> int:
    ...
    # Concurrency: structurally bounded.
    concurrency = {
