#!/usr/bin/env python3
"""CAMPAIGN_017 post-run anti-overfit diagnostic."""
...
from research.anti_overfit.campaign_017 import (
...
def diagnose(
    *,
    ...
    classification = classify_campaign_017(inputs)
    ...
    return {
        ...
        "valid_labels": list(CAMPAIGN_017_CLASSIFIER_LABELS),
...
def _render_md(report: dict[str, Any]) -> str:
    lines = [
        "# CAMPAIGN_017 Null and Anti-Overfit Diagnostics",
        "",
...
def main(argv: list[str] | None = None) -> int:
    ...
    ap.add_argument(
        "--out-json",
        default=str(ROOT / "research/campaign_017/diagnostics/null_and_anti_overfit.json"),
    )
    ap.add_argument(
        "--out-md",
        default=str(ROOT / "research/campaign_017/diagnostics/null_and_anti_overfit.md"),
    )
