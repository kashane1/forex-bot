...
**Stage 2 — data ingestion** (implementation). Design sprint complete.

| Document | Role |
|----------|------|
| [`CRYPTO_DATA_DESIGN_001_SUMMARY.md`](CRYPTO_DATA_DESIGN_001_SUMMARY.md) | Design sprint closeout — locked decisions |
| [`CRYPTO_DATA_SOURCE_EVALUATION.md`](CRYPTO_DATA_SOURCE_EVALUATION.md) | Source trade-offs (Coinbase primary) |
...
- Paper/demo/live execution blocked
- BTC/USD + ETH/USD spot only for Phase 1

## Forex archive

See [`../../FOREX_PROGRAMME_FINAL_STATE.md`](../../FOREX_PROGRAMME_FINAL_STATE.md) and [`../../archive/forex_programme/README.md`](../../archive/forex_programme/README.md).
