...
**Prerequisite:** Forex archive cleanup executed 2026-05-31. Operator review of design deliverables complete.

**Next programme step after this sprint:** authorized data ingestion sprint — see `NEXT_PROMPT_CRYPTO_DATA_INGESTION_001.md`.
