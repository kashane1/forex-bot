...
**Generated:** 2026-05-22T21:02:00.782004+00:00 · **Branch:** `infra-lean-parity-001`
...
| NZD_USD | 9935 | 0 | 0 | 333 | 4 | 0 | 0 | 2.50 | 5.30 | 188 | yes |
...
- Duplicate timestamps: **0**
- Bid / ask availability: **9935 / 9935** of 9935
- Missing intervals (non-weekend, raw): **4**
- Gap classification:
    - expected weekend gaps: **333**
    - expected holiday closures: **4**
    - broker/data outage-like gaps: **0**
    - suspicious short missing bars: **0**
- Median spread: **2.50** pips · p95 spread: **5.30** pips
- Abnormal spreads (> 5× median): **188** (182 on the rollover-close H4 bar, 6 elsewhere)
- **Acceptable for diagnostics / parity:** acceptable for diagnostics / parity

## Verdict

- All 7 pairs are structurally acceptable for diagnostics / parity: completed candles only, full bid/ask coverage, no duplicate timestamps, and a full ~6-year H4 history.
