...
| FRED ingest (main) | `f2ee85d` | infra: FRED full-window ingest succeeded; cross_asset_missing eliminated |
| summary hash | `5e591ea` | docs: record commit hash in blocker resolution summary |
