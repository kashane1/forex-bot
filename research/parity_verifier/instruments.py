...
CAMPAIGN_002_INSTRUMENTS: dict[str, InstrumentSpec] = {
    "EUR_USD": InstrumentSpec(
        name="EUR_USD", pip_size=0.0001, base_currency="EUR",
        quote_currency="USD", display_precision=5,
    ),
    "GBP_USD": InstrumentSpec(
        name="GBP_USD", pip_size=0.0001, base_currency="GBP",
        quote_currency="USD", display_precision=5,
    ),
    "USD_JPY": InstrumentSpec(
        name="USD_JPY", pip_size=0.01, base_currency="USD",
        quote_currency="JPY", display_precision=3,
    ),
    "AUD_USD": InstrumentSpec(
        name="AUD_USD", pip_size=0.0001, base_currency="AUD",
        quote_currency="USD", display_precision=5,
    ),
    "USD_CAD": InstrumentSpec(
        name="USD_CAD", pip_size=0.0001, base_currency="USD",
        quote_currency="CAD", display_precision=5,
    ),
    "USD_CHF": InstrumentSpec(
        name="USD_CHF", pip_size=0.0001, base_currency="USD",
        quote_currency="CHF", display_precision=5,
    ),
    "NZD_USD": InstrumentSpec(
        name="NZD_USD", pip_size=0.0001, base_currency="NZD",
        quote_currency="USD", display_precision=5,
    ),
}
